    ...
    init {
        ...
        literal("help") {
            runs {
                ...
                Signal.fakeMessage("§6/aureon updates on §7Enables update reminders and checks now.")
                Signal.fakeMessage("§6/aureon updates off §7Disables update reminders.")
        ...
        literal("updates") {
            ...
            literal("download") {
                runs {
                    AutoUpdater.downloadApprovedUpdateAsync()
                }
            }
